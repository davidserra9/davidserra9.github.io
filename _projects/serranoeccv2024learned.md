...
img: assets/img/papers/serranoeccv2024learned/figure-curve-example.png
importance: 1
category: work
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/papers/serranoeccv2024learned/figure-curve-example.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
